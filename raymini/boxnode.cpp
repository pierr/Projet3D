...
std::vector<boxleaf> boxnode::sort()
{
    std::vector<boxleaf> supleafs;
    std::vector<boxleaf> midleafs;
    std::vector<boxleaf> infleafs;
    ...
    if(leafs.size()>1){
        ...
        if(infleafs.size()>0){
            boxnode infnode = boxnode(infleafs);
        ...
        if(supleafs.size()>0){
            boxnode supnode = boxnode(supleafs);
