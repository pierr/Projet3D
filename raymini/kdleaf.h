...
{
public:
    kdleaf(int object, int triangle, Material material, Vertex vertex0, Vertex vertex1, Vertex vertex2, Vec3Df v0, Vec3Df v1, Vec3Df v2, Vec3Df n0, Vec3Df n1, Vec3Df n2, Vec3Df camPos);
